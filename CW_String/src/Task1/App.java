...
public class App {
	public static void main(String[] args) throws IOException {
		...
		String[] arr = fullName.split(" ");
			...
			System.out.println("Surnames and initials " + arr[0] + " " + arr[1].substring(0, 1) + ". "
					+ arr[2].substring(0, 1) + ". ");
		...
		System.out.println("-----3-----");
		System.out.println(
				"Please enter five username wich could include 3 to 15 characters of the Latin alphabet, numbers, and underscores");
