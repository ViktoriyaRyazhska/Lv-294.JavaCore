...
public class Sudoku {
    ...
    private int getNumberOfHoles(SudokuLevel sLevel) {
        ...
        if (sLevel == SudokuLevel.EASY) {
            numOfEmptyCell = randomNumb.nextInt((sLevel.getMaximum() - sLevel.getMinimum()) + 1) + sLevel.getMinimum();
        } else if (sLevel == SudokuLevel.MEDIUM) {
            numOfEmptyCell = randomNumb.nextInt((sLevel.getMaximum() - sLevel.getMinimum()) + 1) + sLevel.getMinimum();
        } else if (sLevel == SudokuLevel.HARD) {
            numOfEmptyCell = randomNumb.nextInt((sLevel.getMaximum() - sLevel.getMinimum()) + 1) + sLevel.getMinimum();
        }
